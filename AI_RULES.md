...
- Proyecto: Aura Travel (Transporte corporativo y pSEO).
- Diseño: 'Midnight Opulence', Glassmorphism, variables globales en css/modules/vars.css.

# REGLAS ESTRICTAS DE AHORRO DE TOKENS (OBLIGATORIO)
1. CERO RELLENO: Nunca incluyas saludos, despedidas, ni frases como 'Aquí tienes el código'.
2. CERO EXPLICACIONES: No expliques cómo funciona el código a menos que el usuario escriba explícitamente la palabra 'EXPLICA'.
3. MODO EJECUCIÓN: Al pedir una tarea, modifica los archivos directamente o entrega exclusivamente el bloque de código final.
4. LIMITACIÓN DE BÚSQUEDA: No escanees las carpetas img/, .agents/ ni archivos binarios al buscar contexto.
